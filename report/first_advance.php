...
function firstAdvanceReport($category, $program, $semester)
{
			...
			foreach ($coursesResult as $valueC) {
				...
				$fila = "
						<tr class='" . $class_row . "'>
							...
							<td>$program</td>
							<td>$semester1</td>";
				$recordForums = ItemCourse($value['courseid'], "Avance formativo 1", "foro");
				$recordActivities = ItemCourse($value['courseid'], "Avance formativo 1", "taller");
				$recordMeetings = ItemCourse($value['courseid'], "Avance formativo 1", "encuentro");
